...
- **Must match counts**: Loop must read exactly as many times as goroutines send
...
|---------|-----------|----------|------|
| **Version 1** | Yes | No | Simple: Direct shared memory, just need to wait |
| **Version 2** | No | Yes | Idiomatic: Channels provide sync + communication |
| **Version 3** | Yes | Yes | Production: Need both for timeout + variable results |
